...
// @ts-ignore
type RawParamsFrom<K extends keyof AWSWAF> = AWSWAF[K] extends {
  (param: infer P, callback: (...args: any) => void): Request<infer R, any>;
  (callback: (...args: any) => void): any;
} ? P: never;
...
export class WAF {
  ...
  public readonly service = 'waf' as const;
  ...
  static fromClient(client: AWSWAF): WAF {
    return new WAF(client) as any;
  }
  
  static client(options?: AWSWAF.Types.ClientConfiguration): WAF {
