...
export class CloudWatchEvents implements ClientType {
  ...
  static fromClient(client: AWSCloudWatchEvents): ClientType {
    return new CloudWatchEvents(client) as any;
  }
  
  static client(options?: AWSCloudWatchEvents.Types.ClientConfiguration): ClientType {
